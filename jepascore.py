...
from cropcon.datasets.base import GeoFMDataset, RawGeoFMDataset
...
task=pretraining
dataset=ssl4eov1_1
dataset.multi_temporal=4
task.trainer.log_interval=40
task.trainer.n_global=2
task.trainer.n_local=8
encoder=vit_small
...
work_dir="/home/gcastiglioni/workspace/cropcon"
use_wandb=False
num_workers=4
test_num_workers=4
